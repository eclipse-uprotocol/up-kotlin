...
/**
 * Communication Layer (uP-L2) Subscription Change Handler interface.<BR></BR>
 *
 * This interface provides APIs to handle subscription state changes for a given topic.
 */
fun interface SubscriptionChangeHandler {
    /**
     ...
     */
    fun handleSubscriptionChange(topic: UUri, status: SubscriptionStatus)
}